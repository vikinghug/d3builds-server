...
class SkillCategoriesControllerTest < ActionController::TestCase
  ...
  test "should create skill_category" do
    assert_difference('SkillCategory.count') do
      post :create, skill_category: { klass: @skill_category.klass, skill_id: @skill_category.skill_id, title: @skill_category.title }
    end
  ...
  test "should update skill_category" do
    patch :update, id: @skill_category, skill_category: { klass: @skill_category.klass, skill_id: @skill_category.skill_id, title: @skill_category.title }
    assert_redirected_to skill_category_path(assigns(:skill_category))
  end
